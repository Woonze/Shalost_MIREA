...
- Для одного QR выполняются три успешные попытки подтверждения. После третьей действует настраиваемая пауза, по умолчанию 10 минут. Она не влияет на MTS Link.
